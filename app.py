...
default_query = "일본 도쿄 3박 4일 일정 짜줘. 스시와 사시미가 맛있는 현지 맛집을 꼭 넣고, 저녁에 사진 찍으면서 산책하기 좋은 조용한 공원 방문 일정도 포함해줘. 그리고 매일 아침 웨이트 트레이닝을 할 수 있도록 피트니스 시설이 잘 갖춰진 숙소를 하나 추천해서 전체 일정의 베이스캠프로 삼아줘."
